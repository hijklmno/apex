// Code generated for package boilerplate by go-bindata DO NOT EDIT. (@generated)
// sources:
...
func functionsHelloIndexJs() (*asset, error) {
	...
	info := bindataFileInfo{name: "functions/hello/index.js", size: 147, mode: os.FileMode(420), modTime: time.Unix(1627425045, 0)}
